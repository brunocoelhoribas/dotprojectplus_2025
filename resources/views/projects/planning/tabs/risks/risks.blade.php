<div class="container-fluid p-0">
    <div class="mb-4">
        <div class="d-flex flex-wrap gap-2 justify-content-end mb-3">
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openManagementPlanModal()">
                {{ __('planning/view.risks.actions.management_plan') }}
            </button>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openChecklistModal()">
                {{ __('planning/view.risks.actions.checklist_analysis') }}
            </button>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openWatchListModal()">
                {{ __('planning/view.risks.actions.watch_list') }}
            </button>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openShortTermModal()">
                {{ __('planning/view.risks.actions.short_term_response') }}
            </button>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openLessonsLearnedModal()">
                {{ __('planning/view.risks.actions.lessons_learned') }}
            </button>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openResponseListModal()">
                {{ __('planning/view.risks.actions.response_list') }}
            </button>
        </div>

        <div class="d-flex justify-content-between align-items-center mb-2">
            <h6 class="fw-bold text-dark m-0">{{ __('planning/view.risks.active_risks') }}</h6>
            <button class="btn btn-sm btn-light border shadow-sm" onclick="openNewRiskModal()">
            ...
            <table class="table table-bordered table-hover table-sm align-middle mb-0 small" style="font-size: 0.85rem;">
                ...
                @forelse($activeRisks as $risk)
                    <tr>
                        ...
                        <td class="fw-bold">{{ $risk->risk_name }}</td>
                        ...
                        <td class="text-center">
                            <button class="btn btn-xs btn-link text-dark p-0 me-1" title="Editar" onclick="openEditRiskModal({{ $risk }})">
                                <i class="bi bi-pencil-square"></i>
                            </button>
                            <button class="btn btn-xs btn-link text-dark p-0" title="Visualizar" onclick="openViewRiskModal({{ $risk }})">
        ...
        @if($inactiveRisks->isNotEmpty())
            <h6 class="fw-bold text-muted mb-2 mt-4">{{ __('planning/view.risks.inactive_risks') }}</h6>
                ...
                <table class="table table-bordered table-hover table-sm align-middle mb-0 small" style="font-size: 0.85rem;">
                    ...
                    @foreach($inactiveRisks as $risk)
                        <tr>
                            ...
                            <td>{{ __('planning/view.risks.status.' . $risk->status_key) }}</td>
                            <td class="text-center">
                                <button class="btn btn-xs btn-link text-muted p-0 me-1" title="Editar" onclick="openEditRiskModal({{ $risk }})">
                                    <i class="bi bi-pencil-square"></i>
                                </button>
                                <button class="btn btn-xs btn-link text-muted p-0" title="Visualizar" onclick="openViewRiskModal({{ $risk }})">
                                    <i class="bi bi-journal-text"></i>
                                </button>
                            </td>
                        </tr>
        ...
        <div class="modal-content">
            <form id="riskForm" method="POST">
                ...
                <div class="modal-header bg-warning">
                    <h5 class="modal-title text-dark fw-bold" id="riskModalTitle">Editar Risco</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>

                <div class="modal-body bg-white p-4">
                    @php $labelStyle = 'color: #000; font-weight: bold; font-size: 0.85rem;'; @endphp

                    <h6 class="text-primary fw-bold text-uppercase border-bottom pb-1 mb-3" style="font-size: 0.8rem;">
                        {{ __('planning/view.risks.form.section_id') }}
                    </h6>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.title') }} *:</label>
                        <div class="col-sm-10">
                            <input type="text" name="risk_name" id="risk_name" class="form-control form-control-sm" required>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.cause') }}:</label>
                        <div class="col-sm-10">
                            <textarea name="risk_cause" id="risk_cause" class="form-control form-control-sm" rows="1"></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.consequence') }}:</label>
                        <div class="col-sm-10">
                            <textarea name="risk_consequence" id="risk_consequence" class="form-control form-control-sm" rows="1"></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.description') }} *:</label>
                        <div class="col-sm-10">
                            <textarea name="risk_description" id="risk_description" class="form-control form-control-sm" rows="2" required></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.activity') }}:</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.period') }}:</label>
                        <div class="col-sm-10 d-flex gap-2 align-items-center">
                            <input type="date" name="risk_period_start_date" id="risk_period_start_date" class="form-control form-control-sm" style="width: 150px;">
                            <span>a</span>
                            <input type="date" name="risk_period_end_date" id="risk_period_end_date" class="form-control form-control-sm" style="width: 150px;">
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.ear_classification') }}:</label>
                        <div class="col-sm-4">
                            <select name="risk_ear_classification" id="risk_ear_classification" class="form-select form-select-sm">
                        ...
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.notes') }}:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.potential') }}:</label>
                        <div class="col-sm-10">
                            <select name="risk_potential_other_projects" id="risk_potential_other_projects" class="form-select form-select-sm" style="width: 100px;">
                    ...
                    <h6 class="text-primary fw-bold text-uppercase border-bottom pb-1 mb-3 mt-4" style="font-size: 0.8rem;">
                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            <div class="mb-2 row">
                                <label class="col-sm-4 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.probability') }}:</label>
                                <div class="col-sm-8">
                                    <select name="risk_probability" id="risk_probability" class="form-select form-select-sm" onchange="calculateExposure()">
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-4 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.impact') }}:</label>
                                <div class="col-sm-8">
                                    <select name="risk_impact" id="risk_impact" class="form-select form-select-sm" onchange="calculateExposure()">
                                        <option value="1">{{ __('planning/view.risks.levels.low') }}</option>
                                        <option value="2">{{ __('planning/view.risks.levels.medium') }}</option>
                                        <option value="3">{{ __('planning/view.risks.levels.high') }}</option>
                                        <option value="4">{{ __('planning/view.risks.levels.very_high') }}</option>
                            ...
                            <div class="mb-2 row">
                                <label class="col-sm-4 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.exposure_factor') }}:</label>
                                <div class="col-sm-8">
                                    <input type="text" id="calculated_exposure" class="form-control form-control-sm fw-bold bg-white" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.strategy') }}:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.prevention') }}:</label>
                        <div class="col-sm-10">
                            <textarea name="risk_prevention_actions" id="risk_prevention_actions" class="form-control form-control-sm" rows="2"></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.contingency_reserve') }}</label>
                        <div class="col-sm-10 pt-1">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="risk_is_contingency" id="reserve_yes" value="1">
                                <label class="form-check-label small" for="reserve_yes">{{ __('planning/view.risks.form.yes') }}</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="risk_is_contingency" id="reserve_no" value="0">
                                <label class="form-check-label small" for="reserve_no">{{ __('planning/view.risks.form.no') }}</label>
                            </div>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.contingency_plan') }}:</label>
                        <div class="col-sm-10">
                            <textarea name="risk_contingency_plan" id="risk_contingency_plan" class="form-control form-control-sm" rows="2"></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row border-bottom pb-2">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.trigger') }}:</label>
                        <div class="col-sm-10">
                            <input type="text" name="risk_triggers" id="risk_triggers" class="form-control form-control-sm">
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.responsible') }}:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="mb-2 row">
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.table.status') }}:</label>
                        <div class="col-sm-4">
                        ...
                        <label class="col-sm-2 col-form-label text-end" style="{{ $labelStyle }}">{{ __('planning/view.risks.form.active') }}</label>
                        <div class="col-sm-4">
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold"><i class="bi bi-journal-text me-2"></i>Detalhes do Risco</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            ...
            <div class="modal-body bg-white p-4">
                ...
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-10 fw-bold text-dark" id="view_risk_name"></dd>

                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.cause') }}:</dt>
                    <dd class="col-sm-10" id="view_risk_cause"></dd>

                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.consequence') }}:</dt>
                    <dd class="col-sm-10" id="view_risk_consequence"></dd>

                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.table.description') }}:</dt>
                    ...
                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.ear_classification') }}:</dt>
                ...
                <dl class="row mb-0">
                    ...
                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.contingency_reserve') }}:</dt>
                    <dd class="col-sm-10" id="view_risk_reserve"></dd>

                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.contingency_plan') }}:</dt>
                    ...
                    <dt class="col-sm-2 text-end text-muted small">{{ __('planning/view.risks.form.responsible') }}:</dt>
...
<script>
    var mapLevels = @json(__('planning/view.risks.levels'), JSON_THROW_ON_ERROR);
    var mapStatus = @json(__('planning/view.risks.status'), JSON_THROW_ON_ERROR);
    var mapStrategy = @json(__('planning/view.risks.strategy'), JSON_THROW_ON_ERROR);
    var mapEar = @json(__('planning/view.risks.ear'), JSON_THROW_ON_ERROR);
    var mapYesNo = {
        1: "{{ __('planning/view.risks.form.yes') }}",
        0: "{{ __('planning/view.risks.form.no') }}"
    };

    var keyMapLevels = {1: 'low', 2: 'medium', 3: 'high', 4: 'very_high'};
    var keyMapStatus = {0: 'identified', 1: 'monitored', 2: 'occurred', 3: 'closed'};
    var keyMapStrategy = {0: 'accept', 1: 'avoid', 2: 'mitigate', 3: 'transfer'};
    var keyMapEar = {1: 'organizational', 2: 'technical', 3: 'external', 4: 'pm'};

    var listTasks = @json($tasks, JSON_THROW_ON_ERROR);
    var listUsers = @json($users, JSON_THROW_ON_ERROR);
    ...
    function openManagementPlanModal() {
        var modalEl = document.getElementById('managementPlanModal');
    ...
    function openViewRiskModal(risk) {
        ...
        var start = risk.risk_period_start_date ? formatDate(risk.risk_period_start_date) : '...';
        var end = risk.risk_period_end_date ? formatDate(risk.risk_period_end_date) : '...';
        setText('view_risk_period', `${start} a ${end}`);

        var earKey = keyMapEar[risk.risk_ear_classification] || 'organizational';
        ...
        var probKey = keyMapLevels[risk.risk_probability] || 'low';
        var impKey = keyMapLevels[risk.risk_impact] || 'low';
        ...
        const score = p * i;
        var expLabel = mapLevels.low;
        var expClass = 'bg-success text-white';
        ...
        var stratKey = keyMapStrategy[risk.risk_strategy] || 'accept';
        ...
        var statusKey = keyMapStatus[risk.risk_status] || 'identified';
        setText('view_risk_status', mapStatus[statusKey]);

        var activeText = (risk.risk_active === 0) ? mapYesNo[1] : mapYesNo[0];
    ...
    function openEditRiskModal(risk) {
        ...
        var url = "{{ route('projects.risks.update', ['project' => $project->project_id, 'risk' => ':ID']) }}";
